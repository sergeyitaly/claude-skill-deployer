...
| github-actions-ci | `**/.github/workflows/*.yml, **/.github/workflows/*.yaml` — Debug GitHub Actions pipeline failures and reproduce CI stages locally. Use when asked to debug CI, fix a failing workflow, reproduce a job with act, or run a pre-flight check before pushing. |
