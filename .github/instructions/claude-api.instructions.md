---
name: "claude-api"
description: "Reference for the Claude API and Anthropic SDK (models, pricing, streaming, tool use, MCP, agents, caching, migration). Use when the prompt names Claude/Anthropic or for unstated LLM/agent tasks; see When to use in the body for skip rules."
applyTo: "**/*"
---
