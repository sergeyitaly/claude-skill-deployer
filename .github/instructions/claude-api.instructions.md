...
---
name: claude-api
description: Reference for the Claude API / Anthropic SDK — model ids, pricing, params, streaming, tool use, MCP, agents, caching, token counting, model migration. Use when the prompt names Claude/Anthropic, asks about LLM pricing/limits/caching, or involves agent/MCP/tool-definition tasks. Skip when another provider (OpenAI, Gemini, Llama, etc.) is explicitly named.
