...
- 4 new regression tests (`hookOps.test.ts` ×2, `hookHandlers.test.ts` ×2) covering the dead-hook cleanup and the installed-vs-catalog skill distinction, including one using the exact `manage-saa-c03-reference` name from the audit report.
