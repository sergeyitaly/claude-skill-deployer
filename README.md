...
**v1.0.112** — AI agent skill deployment, cost intelligence, HACE coaching, adaptive learning, Skill Adoption Intelligence, Skill Enrichment Intelligence, Workspace Intelligence, Telemetry Integrity Audit framework, and native Compliance Audit Framework for automated and manual audit execution for Claude, Cursor, Kiro, and GitHub Copilot.
...
**Current version:** 1.0.112 (`serhiivoinolovych.claude-skill-deployer`)
