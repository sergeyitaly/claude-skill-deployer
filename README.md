...
**v1.0.127** — AI agent skill deployment, cost intelligence, HACE coaching, adaptive learning, Skill Adoption Intelligence, Skill Enrichment Intelligence, Workspace Intelligence, and Telemetry Integrity Audit framework for Claude, Cursor, Kiro, and GitHub Copilot.
...
**Current version:** 1.0.127 (`serhiivoinolovych.claude-skill-deployer`)
